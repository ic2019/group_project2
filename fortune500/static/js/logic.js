...
function buildMarker(features) {
   features.forEach(feature=>{
      console.log("For Each");
       L.circle([feature.lat, feature.long, {
           fillColor: getcolor(feature.revenue),
           fillOpacity: .65,
           color: "#999999",
           weight: 1,
           radius: plotsize(feature.revenue) 
       }]).bindPopup('<p><b>Company</b>: ' + feature.comp)  //+ '</p><p><b>When</b>:' + new Date(feature.properties.time) + '</p>' + '<p><b>Richter</b>: ' + feature.revenue)
